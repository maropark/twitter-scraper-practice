...
def get_elements(twitter_handle):
  ...
  #get just content from HTML
  html = response.content
  
  #use BeautifulSoup to analyse HTML content
...
'''A Regular Expression (or regex) is a sequence of characters which create a
search pattern.
We can use it to remove all data that doesn’t match our regex search
criteria.'''
